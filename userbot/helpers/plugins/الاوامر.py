# commands for source Ralls by ~ @N7QQQ
...
########################  SOURCE 𝐑𝐀𝐈𝐈𝐒𝙏𝙃𝙊𝙉 ~ BY: علش (@RallsThon)  ########################
...
DEFAULTUSER = "Ralls"
CAT_IMG = "https://telegra.ph/file/637fe91a75c073278e4da.jpg"
CUSTOM_ALIVE_TEXT = "𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒 - 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹 𓆪"
EMOJI = "  𓄂† "
...
async def dev(alive):
    ...
    if CAT_IMG:
        ...
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 1 ↬ @N7QQQ ༗\n"
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @A_A7A ༗\n"
        cat_caption += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝐑𝐀𝐈𝐈𝐒ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
        ...
        await edit_or_reply(
            ...
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 1 ↬ @N7QQQ ༗\n"
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @A_A7A ༗\n"
