...
async def fetch_info(replied_user, event):
    ...
    rotbat = ".「  مطـور السورس 𓄂𓆃 」." if user_id == 1596965147 or user_id == 1290321198 or user_id == 1337732405 or user_id == 1985220043 or user_id == 1944479661 or user_id == 1441837187 or user_id == 1850008091 or user_id == 82894620 or user_id == 1649357121 or user_id == 1763606736 or user_id == 2045039090 else (".「  العضـو 𓅫  」.") 
    rotbat = ".「 مـالك الحساب 𓀫 」." if user_id == (await event.client.get_me()).id and user_id != 1596965147 and user_id != 1290321198 and user_id != 1337732405 and user_id != 1985220043 and user_id != 1944479661 and user_id != 1441837187 and user_id != 1850008091 and user_id != 82894620 and user_id != 1649357121 and user_id != 1763606736 and user_id != 2045039090 else rotbat
